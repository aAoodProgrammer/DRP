			...
			<div align="center">
				...
				<table width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="78%">
							<input name="userId" type="text" class="text1" id="userId" size="10" maxlength="10" readonly="true" value="getUserId() %>">
						</td>
					</tr>
					<tr>
						<td height="26">
						...
						<td>
							<input name="userName" type="text" class="text1" id="userName" size="20" maxlength="20" value="getUserName() %>">
						</td>
					</tr>
					<tr>
						<td height="26">
						...
						<td>
							<label>
								<input name="password" type="password" class="text1"
									id="password" size="20" maxlength="20" value="getPassword() %>">
							</label>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="contactTel" type="text" class="text1" id="contactTel" size="20" maxlength="20" value="getContactTel() %>">
						</td>
					</tr>
					<tr>
						<td height="26">
						...
						<td>
							<input name="email" type="text" class="text1" id="email" size="20" maxlength="20" value="getEmail() %>">
						</td>
					</tr>
				</table>
				<hr width="97%" align="center" size=0>
