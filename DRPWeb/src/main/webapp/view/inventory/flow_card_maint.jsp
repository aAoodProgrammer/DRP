...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			...
			function topPage() {
				window.self.location = "${basePath}servlet/inventory/FlowcardServlet?pageNo=${pageModel.topPageNo}&clientId=${param.clientId}&clientName=${param.clientName}&beginDate=${beginDate}&endDate=${endDate}";
			}

			function previousPage() {
				window.self.location = "${basePath }servlet/inventory/FlowcardServlet?pageNo=${pageModel.previousPageNo}&clientId=${param.clientId}&clientName=${param.clientName}&beginDate=${beginDate}&endDate=${endDate}";
			}

			function nextPage() {

				window.self.location = "${basePath }servlet/inventory/FlowcardServlet?pageNo=${pageModel.nextPageNo}&clientId=${param.clientId}&clientName=${param.clientName}&beginDate=${beginDate}&endDate=${endDate}";
			}

			function bottomPage() {
				window.self.location = "${basePath }servlet/inventory/FlowcardServlet?pageNo=${pageModel.buttomPageNo}&clientId=${param.clientId}&clientName=${param.clientName}&beginDate=${beginDate}&endDate=${endDate}";
			}
	...
	<body class="body1">
		<form name="flowCardForm" action="servlet/flowCardForm/FlowcardServlet" method="post">
			<div align="center">
				...
				<table width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="23%">
							<input name="clientId" type="text" class="text1" id="clientId" size="10" maxlength="10" readonly="true" value="${param.clientId }">
						...
						<td width="37%">
							<input name="clientName" type="text" class="text1" id="clientName" size="40" maxlength="40" readonly="true" value="${param.clientName }">
						</td>
						<td width="11%">
					...
					<tr>
						...
						<td>
							<input type="text" name="beginDate" size="10" maxlength="10" value="${beginDate}" readonly="true" onClick=JSCalendar(this)>
						</td>
						<td>
							<div align="right">
								结束日期:&nbsp;
						...
						<td>
							<input type="text" name="endDate" size="10" maxlength="10" value="${endDate}" readonly="true" onClick=JSCalendar(this)>
						</td>
						<td>
							<input name="btnReset" type="button" class="button1" id="btnReset" value="重置" onClick="resetFlowCard()">
						</td>
					</tr>
				</table>
				...
				<table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" class="table1" title="点击选中的数据查看详细信息...">
					...
					<tr>
						<td width="37" class="rd8">
							<input name="selectFlag" type="checkbox" class="checkbox1" id="selectFlag" value="checkbox">
						</td>
						<td width="88" class="rd8">
							<a href="flow_card_maint.jsp" onClick="window.open('flow_card_detail.html', '流向单详细信息', 'width=800, height=400, scrollbars=no')">
								flowCard.flowCardNo
							</a>
						</td>
						...
						<td width="197" class="rd8">
							flowCard.optDate "yyyy-MM-dd HH:mm:ss"
						</td>
					</tr>
