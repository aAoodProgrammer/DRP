...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			...
			function addForCard() {
				window.self.location = "${ctx}/view/inventory/checkvou_add.jsp";
			}

			function modifyForCard() {
				window.self.location = "${ctx}/view/inventory/checkvou_modify.jsp";
			}
		</script>
	</head>
	...
	<body>
		...
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				<dl class="am-icon-home" style="float: left;"> 当前位置： 分销商库存管理 >盘点结果维护
				</dl>
			</div>
