	...
	<body class="body1">
		<form name="clientForm">
			...
			<table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" class="table1">
				...
				<tr>
					<td class="rd8"><input type="radio" name="selectFlag" value="radiobutton" onDblClick="doubleclick('getId', 'getTemiOrClientId()', 'getName')"></td>
					<td class="rd8">getTemiOrClientId() %></td>
					<td class="rd8">getName() %></td>
					<td class="rd8">getLevelName() %></td>
				</tr>
