			...
			<div align="center">
				...
				<table width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="78%">
							<input name="clientId" type="text" class="text1" id="clientId" size="10" maxlength="10" onBlur="validateClientId(this)"><span id="clientIdSpan"></span>
						</td>
					</tr>
					<tr>
						<td height="26">
						...
						<td>
							<input name="clientName" type="text" class="text1" id="clientName" size="40" maxlength="40">
						</td>
					</tr>
					<tr>
						<td height="15">
				...
				<div align="center">
					...
					<input name="btnBack" class="button1" type="button" id="btnBack" value="返回" onClick="location='<%=path%>/view/basicData/client_node_crud.jsp?id=pid'" />
				</div>
			</div>
		</form>
	</body>
