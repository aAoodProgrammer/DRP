...
<html>
	...
	<head>
		...
		<script src="<%=path%>/js/windows.js"></script>
		
		<script type="text/javascript">
			function addItem() {
				window.self.location = "<%=path%>/view/basicData/item_add.jsp";
			}
			...
			function modifyItem() {
				...
				window.self.location = "<%=path%>/view/basicData/item_modify.jsp";
			...
			function uploadPic4Item() {
				...
				window.self.location = "<%=path%>/view/basicData/item_upload.jsp";
				//window.self.location = "<%=basePath %>servlet/basicData/ShowItemUploadServlet?itemNo=" + selectFlags[index].value;
			}
		</script>
	</head>
		...
		<form name="itemForm">
			<div align="center">
				...
				<table width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="57%">
							<input name="clientIdOrName" type="text" class="text1" id="clientIdOrName" size="50" maxlength="50" value="${param.clientIdOrName}">
						</td>
						<td width="26%">
							<div align="left">
								<input name="btnQuery" type="button" class="button1" id="btnQuery" value="查询" onClick="searchItem()">
							</div>
						</td>
					</tr>
					<tr>
			...
			<table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" class="table1">
				...
				<tr>
					...
					<td class="rd8">
						<input type="checkbox" name="selectFlag" class="checkbox1" value="itemNo }">
					</td>
					<td class="rd8">
						<a href="<%=path%>/view/basicData/item_maint.jsp" onClick="window.open('<%=path%>/view/basicData/item_detail.html', '物料详细信息', 'width=400, height=400, scrollbars=no')">itemNo</a>
					</td>
					<td class="rd8">
						itemName
					</td>
