    ...
    <div align="center">
        ...
        <table width="95%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="78%">
                    <input name="fiscalYear" type="text" class="text1" value="getFiscalYear() %>" id="fiscalYear"
            ...
            <tr>
                ...
                <td>
                    <input name="fiscalPeriod" type="text" class="text1" value="getFiscalPeriod() %>" id="fiscalPeriod"
                           size="10" maxlength="10" readonly="true">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input type="text" name="beginDate" id="beginDate" size="10" maxlength="10" value="new SimpleDateFormat("yyyy-MM-dd").format(getBeginDate())" readonly="true" onClick=JSCalendar(this)>
                        </input>
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input name="endDate" type="text" id="endDate" onClick=JSCalendar(this)
                           value="<%=new SimpleDateFormat(" yyyy-MM-dd ").format(new Date()) %>" size="10"
            ...
            <tr>
                ...
                <td>
                    <input name="periodSts" type="checkbox" class="checkbox1"
                           getPeriodSts().equals(&quot;N&quot;)?&quot;&quot;:&quot;checked&quot;&gt;id=&quot;periodSts&quot;&gt;>
                </td>
            </tr>
        </table>
        <hr width="97%" align="center" size=0>
